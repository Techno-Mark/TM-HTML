...
$(document).ready(function () {
  ...
  $("#case-slide").slick({
    ...
    autoplay: false,
    prevArrow:
      '<div class="slick-prev slick-arrow"><img src="assets/images/Arrow-slideleft.png"></div>',
    nextArrow:
      '<div class="slick-next slick-arrow"><img src="assets/images/Arrow-slideright.png"></div>',
    responsive: [
      {
        breakpoint: 1450,
        settings: {
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    const organizationNameError = document.getElementById(
      "organizationNameError"
    );
    const projectDescriptionError = document.getElementById(
